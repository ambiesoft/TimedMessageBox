...
enum TIMEDMESSAGEBOX_FLAGS
{
	...
	TIMEDMESSAGEBOX_FLAGS_HIDECOPY		= 1 << 4,
	TIMEDMESSAGEBOX_FLAGS_HIDEKEEP		= 1 << 5,
	TIMEDMESSAGEBOX_FLAGS_HIDERETRY		= 1 << 6,
	TIMEDMESSAGEBOX_FLAGS_HIDEOK		= 1 << 7,
	TIMEDMESSAGEBOX_FLAGS_HIDECANCEL	= 1 << 8,
	TIMEDMESSAGEBOX_FLAGS_KEEPTOPMOST	= 1 << 9,
};
